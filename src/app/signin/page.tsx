    ...
    <div className="flex items-center justify-center py-12">
      <Card className="w-full max-w-md bg-card/50 backdrop-blur-sm">
        <CardHeader>
          ...
          <CardDescription>Enter your registered mobile number, email, or admin credentials to sign in.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={!csrfToken || !login || !password}>
