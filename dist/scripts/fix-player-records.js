...
async function fixPlayerRecords() {
    ...
    for (const user of users) {
        ...
        if (!user.player) {
            console.log('No Player record found for ' + userName + '. Creating one...');
            ...
            console.log('Created Player record for ' + userName + ' with userId: ' + user.id);
        }
        else {
            console.log('Player record already exists for ' + userName + ' with status: ' + user.player.status);
        }
    }
