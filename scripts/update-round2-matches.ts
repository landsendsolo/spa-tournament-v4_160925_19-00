...
async function updateRound2Matches() {
  try {
    ...
    const matches = [
      ...
      {
        player1: "Ross Hutchison",
        player2: "Stevie Stores",
        score1: 6,
        score2: 7,
        status: "COMPLETED",
        drawOrder: 14,
      ...
      {
        player1: "Jayde Devlin",
        player2: "Daniel Wylie",
        score1: 7,
        score2: 6,
        status: "COMPLETED",
        drawOrder: 16,
      ...
      {
        player1: "Steven Couper",
        player2: "Jonny Robertson",
        score1: 7,
        score2: 0,
        status: "PENDING",
        drawOrder: 17,
      ...
      {
        player1: "Kevin Galligan",
        player2: "Mark Lockhart",
        score1: 7,
        score2: 1,
        status: "COMPLETED",
        drawOrder: 18,
    ...
    for (const match of matches) {
      ...
      if (!player1 || !player2) {
        console.log(
          `Skipping match: ${match.player1} vs ${match.player2} - player not found`,
        );
        continue;
      }
