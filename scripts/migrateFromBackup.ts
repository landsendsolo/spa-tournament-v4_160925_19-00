...
async function main() {
  ...
  console.log(
    `Found: ${backupUsers.length} users, ${backupPlayers.length} players, ${backupMatches.length} matches.`,
  );
  ...
  console.log(
    "✅ Migration complete. Your database is now an exact copy of your backup, with the corrected schema.",
  );
}
